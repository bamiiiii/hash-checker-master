...
public class MainActivity extends BaseActivity {
    ...
    public void onClickDetectAsync(View v){
        avsuit.detectAsync(60);
    }
    ...
    public void cancelDetectAsync(View v){
        avsuit.cancelDetectAsync();
    }
    public void exitAVSuit(View v){
        avsuit.exit();
    }
    public void getAVsuitVersion(View v){
        String avsuitVersion = avsuit.getVersion();
        Toast.makeText(this,
                "avsuit library version is : " + avsuitVersion,
