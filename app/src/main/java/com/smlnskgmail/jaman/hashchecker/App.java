...
public class App extends android.app.Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        AVSuit.setup(this, true, true, false);
        AVSuit.setUpdatePeriod(60);

//        AVSuit.clear();
//        AVSuit.setRadarUrl("http://172.16.20.100:8088/radar/");
        AVSuit.setRadarUrl("https://radar.appsu.it/radar/");
    }
